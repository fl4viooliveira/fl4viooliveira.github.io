    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file, 20, 12, 546);
    			attr_dev(a0, "href", "#0");
    			attr_dev(a0, "class", "btn svelte-9ado1z");
    			add_location(a0, file, 22, 12, 877);
    			...
    			add_location(img1, file, 25, 29, 984);
    			attr_dev(a1, "href", "#0");
    			attr_dev(a1, "class", "svelte-9ado1z");
    			add_location(a1, file, 25, 16, 971);
    			attr_dev(li0, "class", "svelte-9ado1z");
    			add_location(li0, file, 25, 12, 967);
    			...
    			add_location(img2, file, 26, 29, 1069);
    			attr_dev(a2, "href", "#0");
    			attr_dev(a2, "class", "svelte-9ado1z");
    			add_location(a2, file, 26, 16, 1056);
    			attr_dev(li1, "class", "svelte-9ado1z");
    			add_location(li1, file, 26, 12, 1052);
    			...
    			add_location(img3, file, 27, 29, 1152);
    			attr_dev(a3, "href", "#0");
    			attr_dev(a3, "class", "svelte-9ado1z");
    			add_location(a3, file, 27, 16, 1139);
    			attr_dev(li2, "class", "svelte-9ado1z");
    			add_location(li2, file, 27, 12, 1135);
    			attr_dev(ul0, "class", "sci svelte-9ado1z");
    			add_location(ul0, file, 24, 8, 938);
    			...
    			add_location(h21, file, 34, 8, 1342);
    			attr_dev(p1, "class", "svelte-9ado1z");
    			add_location(p1, file, 35, 8, 1368);
    			attr_dev(div4, "class", "title white svelte-9ado1z");
    			add_location(div4, file, 33, 4, 1308);
    			attr_dev(br0, "class", "svelte-9ado1z");
    			add_location(br0, file, 41, 233, 1982);
    			attr_dev(br1, "class", "svelte-9ado1z");
    			add_location(br1, file, 41, 237, 1986);
    			attr_dev(p2, "class", "svelte-9ado1z");
    			add_location(p2, file, 39, 12, 1510);
    			attr_dev(div5, "class", "textBx svelte-9ado1z");
    			add_location(div5, file, 38, 8, 1477);
