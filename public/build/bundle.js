...
var app = (function () {
    ...
    */
     ...
     */
    // Canvas
    document.querySelector("canvas#canvas1");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "toggle svelte-18cudep");
    			...
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-18cudep");
    			add_location(img0, file, 21, 8, 424);
    			attr_dev(div1, "class", "imgSidebar svelte-18cudep");
    			add_location(div1, file, 20, 4, 391);
    			attr_dev(canvas, "class", "contentBx svelte-18cudep");
    			attr_dev(canvas, "id", "canvas1");
    			add_location(canvas, file, 24, 4, 502);
    			attr_dev(h5, "class", "logoText svelte-18cudep");
    			add_location(h5, file, 25, 6, 575);
    			attr_dev(span, "class", "svelte-18cudep");
    			add_location(span, file, 27, 16, 661);
    			attr_dev(h40, "class", "svelte-18cudep");
    			add_location(h40, file, 27, 12, 657);
    			attr_dev(h20, "class", "svelte-18cudep");
    			add_location(h20, file, 28, 12, 702);
    			attr_dev(h41, "class", "svelte-18cudep");
    			add_location(h41, file, 29, 12, 739);
    			attr_dev(p0, "class", "svelte-18cudep");
    			add_location(p0, file, 30, 12, 806);
    			attr_dev(a0, "href", "#about");
    			attr_dev(a0, "class", "btn svelte-18cudep");
    			add_location(a0, file, 31, 12, 1162);
    			attr_dev(div2, "class", "frontPageText svelte-18cudep");
    			add_location(div2, file, 26, 8, 617);
    			if (img1.src !== (img1_src_value = "images/facebook.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "facebook");
    			attr_dev(img1, "class", "svelte-18cudep");
    			add_location(img1, file, 34, 29, 1273);
    			attr_dev(a1, "href", "#0");
    			attr_dev(a1, "class", "svelte-18cudep");
    			add_location(a1, file, 34, 16, 1260);
    			attr_dev(li0, "class", "svelte-18cudep");
    			add_location(li0, file, 34, 12, 1256);
    			...
    			attr_dev(img2, "class", "svelte-18cudep");
    			add_location(img2, file, 35, 61, 1390);
    			attr_dev(a2, "href", "https://twitter.com/fl4viooliveira");
    			attr_dev(a2, "class", "svelte-18cudep");
    			add_location(a2, file, 35, 16, 1345);
    			attr_dev(li1, "class", "svelte-18cudep");
    			add_location(li1, file, 35, 12, 1341);
    			if (img3.src !== (img3_src_value = "images/instagram.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "instagram");
    			attr_dev(img3, "class", "svelte-18cudep");
    			add_location(img3, file, 36, 29, 1489);
    			attr_dev(a3, "href", "#0");
    			attr_dev(a3, "class", "svelte-18cudep");
    			add_location(a3, file, 36, 16, 1476);
    			attr_dev(li2, "class", "svelte-18cudep");
    			add_location(li2, file, 36, 12, 1472);
    			attr_dev(ul0, "class", "sci svelte-18cudep");
    			add_location(ul0, file, 33, 8, 1227);
    			attr_dev(div3, "class", "contentBx svelte-18cudep");
    			add_location(div3, file, 23, 4, 472);
    			attr_dev(section0, "class", "banner svelte-18cudep");
    			attr_dev(section0, "id", "home");
    			add_location(section0, file, 19, 0, 352);
    			attr_dev(h21, "class", "svelte-18cudep");
    			add_location(h21, file, 43, 8, 1679);
    			attr_dev(p1, "class", "svelte-18cudep");
    			add_location(p1, file, 44, 8, 1705);
    			attr_dev(div4, "class", "title white svelte-18cudep");
    			add_location(div4, file, 42, 4, 1645);
    			attr_dev(br0, "class", "svelte-18cudep");
    			add_location(br0, file, 49, 515, 2380);
    			attr_dev(br1, "class", "svelte-18cudep");
    			add_location(br1, file, 49, 519, 2384);
    			attr_dev(br2, "class", "svelte-18cudep");
    			add_location(br2, file, 50, 76, 2465);
    			attr_dev(br3, "class", "svelte-18cudep");
    			add_location(br3, file, 51, 199, 2670);
    			attr_dev(br4, "class", "svelte-18cudep");
    			add_location(br4, file, 51, 203, 2674);
    			attr_dev(p2, "class", "svelte-18cudep");
    			add_location(p2, file, 48, 12, 1861);
    			attr_dev(div5, "class", "textBx svelte-18cudep");
    			add_location(div5, file, 47, 8, 1828);
    			if (img4.src !== (img4_src_value = "images/flavio_pc.PNG")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "Flavio");
    			attr_dev(img4, "class", "svelte-18cudep");
    			add_location(img4, file, 56, 12, 2944);
    			attr_dev(div6, "class", "imgBx svelte-18cudep");
    			add_location(div6, file, 55, 8, 2912);
    			attr_dev(div7, "class", "content svelte-18cudep");
    			add_location(div7, file, 46, 4, 1798);
    			attr_dev(section1, "class", "about svelte-18cudep");
    			attr_dev(section1, "id", "about");
    			add_location(section1, file, 41, 0, 1606);
    			attr_dev(h22, "class", "svelte-18cudep");
    			add_location(h22, file, 63, 8, 3123);
    			attr_dev(p3, "class", "svelte-18cudep");
    			add_location(p3, file, 64, 8, 3153);
    			attr_dev(div8, "class", "title svelte-18cudep");
    			add_location(div8, file, 62, 4, 3095);
    			...
    			attr_dev(img5, "class", "svelte-18cudep");
    			add_location(img5, file, 68, 12, 3398);
    			attr_dev(h23, "class", "svelte-18cudep");
    			add_location(h23, file, 69, 12, 3475);
    			attr_dev(p4, "class", "svelte-18cudep");
    			add_location(p4, file, 70, 12, 3512);
    			attr_dev(div9, "class", "servicesBx svelte-18cudep");
    			add_location(div9, file, 67, 8, 3361);
    			if (img6.src !== (img6_src_value = "images/webdesign.png")) attr_dev(img6, "src", img6_src_value);
    			attr_dev(img6, "alt", "Web Development icon");
    			attr_dev(img6, "class", "svelte-18cudep");
    			add_location(img6, file, 73, 12, 3724);
    			attr_dev(h24, "class", "svelte-18cudep");
    			add_location(h24, file, 74, 12, 3796);
    			attr_dev(p5, "class", "svelte-18cudep");
    			add_location(p5, file, 75, 12, 3828);
    			attr_dev(div10, "class", "servicesBx svelte-18cudep");
    			add_location(div10, file, 72, 8, 3687);
    			if (img7.src !== (img7_src_value = "images/frontend.png")) attr_dev(img7, "src", img7_src_value);
    			attr_dev(img7, "alt", "Frontend icon");
    			attr_dev(img7, "class", "svelte-18cudep");
    			add_location(img7, file, 78, 12, 4043);
    			attr_dev(h25, "class", "svelte-18cudep");
    			add_location(h25, file, 79, 12, 4107);
    			attr_dev(p6, "class", "svelte-18cudep");
    			add_location(p6, file, 80, 12, 4137);
    			attr_dev(div11, "class", "servicesBx svelte-18cudep");
    			add_location(div11, file, 77, 8, 4006);
    			if (img8.src !== (img8_src_value = "images/backend.png")) attr_dev(img8, "src", img8_src_value);
    			attr_dev(img8, "alt", "Backend icon");
    			attr_dev(img8, "class", "svelte-18cudep");
    			add_location(img8, file, 83, 12, 4361);
    			attr_dev(h26, "class", "svelte-18cudep");
    			add_location(h26, file, 84, 12, 4423);
    			attr_dev(p7, "class", "svelte-18cudep");
    			add_location(p7, file, 85, 12, 4452);
    			attr_dev(div12, "class", "servicesBx svelte-18cudep");
    			add_location(div12, file, 82, 8, 4324);
    			if (img9.src !== (img9_src_value = "images/deployment.png")) attr_dev(img9, "src", img9_src_value);
    			attr_dev(img9, "alt", "Deployment icon");
    			attr_dev(img9, "class", "svelte-18cudep");
    			add_location(img9, file, 88, 12, 4681);
    			attr_dev(h27, "class", "svelte-18cudep");
    			add_location(h27, file, 89, 12, 4749);
    			attr_dev(p8, "class", "svelte-18cudep");
    			add_location(p8, file, 90, 12, 4781);
    			attr_dev(div13, "class", "servicesBx svelte-18cudep");
    			add_location(div13, file, 87, 8, 4644);
    			...
    			attr_dev(img10, "class", "svelte-18cudep");
    			add_location(img10, file, 93, 10, 4957);
    			attr_dev(h28, "class", "svelte-18cudep");
    			add_location(h28, file, 94, 10, 5029);
    			attr_dev(p9, "class", "svelte-18cudep");
    			add_location(p9, file, 95, 8, 5069);
    			attr_dev(div14, "class", "servicesBx svelte-18cudep");
    			add_location(div14, file, 92, 8, 4922);
    			attr_dev(div15, "class", "content svelte-18cudep");
    			add_location(div15, file, 66, 4, 3331);
    			attr_dev(section2, "class", "services svelte-18cudep");
    			attr_dev(section2, "id", "services");
    			add_location(section2, file, 61, 0, 3050);
    			attr_dev(h29, "class", "svelte-18cudep");
    			add_location(h29, file, 102, 8, 5373);
    			attr_dev(p10, "class", "svelte-18cudep");
    			add_location(p10, file, 103, 8, 5402);
    			attr_dev(div16, "class", "title svelte-18cudep");
    			add_location(div16, file, 101, 4, 5345);
    			if (img11.src !== (img11_src_value = "images/img1.jpg")) attr_dev(img11, "src", img11_src_value);
    			attr_dev(img11, "alt", "work-1");
    			attr_dev(img11, "class", "svelte-18cudep");
    			add_location(img11, file, 108, 16, 5671);
    			attr_dev(div17, "class", "imgBx svelte-18cudep");
    			add_location(div17, file, 107, 12, 5619);
    			attr_dev(h30, "class", "svelte-18cudep");
    			add_location(h30, file, 112, 16, 5905);
    			attr_dev(a4, "href", "https://fl4viooliveira.github.io/bkg_grid_layout/");
    			attr_dev(a4, "target", "_blank");
    			attr_dev(a4, "class", "svelte-18cudep");
    			add_location(a4, file, 111, 16, 5797);
    			attr_dev(div18, "class", "textBx svelte-18cudep");
    			add_location(div18, file, 110, 12, 5759);
    			attr_dev(div19, "class", "workBx svelte-18cudep");
    			add_location(div19, file, 106, 8, 5586);
    			if (img12.src !== (img12_src_value = "images/img2.jpg")) attr_dev(img12, "src", img12_src_value);
    			attr_dev(img12, "alt", "work-2");
    			attr_dev(img12, "class", "svelte-18cudep");
    			add_location(img12, file, 118, 16, 6058);
    			attr_dev(div20, "class", "imgBx svelte-18cudep");
    			add_location(div20, file, 117, 12, 6022);
    			attr_dev(h31, "class", "svelte-18cudep");
    			add_location(h31, file, 122, 20, 6277);
    			attr_dev(a5, "href", "https://fl4viooliveira.github.io/animated_form/");
    			attr_dev(a5, "target", "_blank");
    			attr_dev(a5, "class", "svelte-18cudep");
    			add_location(a5, file, 121, 16, 6167);
    			attr_dev(div21, "class", "textBx svelte-18cudep");
    			add_location(div21, file, 120, 12, 6130);
    			attr_dev(div22, "class", "workBx svelte-18cudep");
    			add_location(div22, file, 116, 8, 5989);
    			if (img13.src !== (img13_src_value = "images/img3.jpg")) attr_dev(img13, "src", img13_src_value);
    			attr_dev(img13, "alt", "work-3");
    			attr_dev(img13, "class", "svelte-18cudep");
    			add_location(img13, file, 128, 16, 6432);
    			attr_dev(div23, "class", "imgBx svelte-18cudep");
    			add_location(div23, file, 127, 12, 6396);
    			attr_dev(h32, "class", "svelte-18cudep");
    			add_location(h32, file, 132, 20, 6650);
    			attr_dev(a6, "href", "https://fl4viooliveira.github.io/profile_card/");
    			attr_dev(a6, "target", "_blank");
    			attr_dev(a6, "class", "svelte-18cudep");
    			add_location(a6, file, 131, 16, 6541);
    			attr_dev(div24, "class", "textBx svelte-18cudep");
    			add_location(div24, file, 130, 12, 6504);
    			attr_dev(div25, "class", "workBx svelte-18cudep");
    			add_location(div25, file, 126, 8, 6363);
    			if (img14.src !== (img14_src_value = "images/img4.jpg")) attr_dev(img14, "src", img14_src_value);
    			attr_dev(img14, "alt", "work-4");
    			attr_dev(img14, "class", "svelte-18cudep");
    			add_location(img14, file, 138, 16, 6804);
    			attr_dev(div26, "class", "imgBx svelte-18cudep");
    			add_location(div26, file, 137, 12, 6768);
    			attr_dev(h33, "class", "svelte-18cudep");
    			add_location(h33, file, 142, 20, 7028);
    			attr_dev(a7, "href", "https://fl4viooliveira.github.io/blogr_landing_page/");
    			attr_dev(a7, "target", "_blank");
    			attr_dev(a7, "class", "svelte-18cudep");
    			add_location(a7, file, 141, 16, 6913);
    			attr_dev(div27, "class", "textBx svelte-18cudep");
    			add_location(div27, file, 140, 12, 6876);
    			attr_dev(div28, "class", "workBx svelte-18cudep");
    			add_location(div28, file, 136, 8, 6735);
    			attr_dev(div29, "class", "content svelte-18cudep");
    			add_location(div29, file, 105, 4, 5556);
    			attr_dev(section3, "class", "work svelte-18cudep");
    			attr_dev(section3, "id", "work");
    			add_location(section3, file, 100, 0, 5308);
    			attr_dev(h210, "class", "svelte-18cudep");
    			add_location(h210, file, 183, 8, 8194);
    			attr_dev(p11, "class", "svelte-18cudep");
    			add_location(p11, file, 184, 8, 8222);
    			attr_dev(div30, "class", "title white svelte-18cudep");
    			add_location(div30, file, 182, 4, 8160);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "name", "first_name");
    			attr_dev(input0, "placeholder", "First Name");
    			attr_dev(input0, "class", "svelte-18cudep");
    			add_location(input0, file, 190, 20, 8547);
    			attr_dev(div31, "class", "col50 svelte-18cudep");
    			add_location(div31, file, 189, 16, 8507);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "last_name");
    			attr_dev(input1, "placeholder", "Last Name");
    			attr_dev(input1, "class", "svelte-18cudep");
    			add_location(input1, file, 193, 20, 8689);
    			attr_dev(div32, "class", "col50 svelte-18cudep");
    			add_location(div32, file, 192, 16, 8649);
    			attr_dev(div33, "class", "row svelte-18cudep");
    			add_location(div33, file, 188, 12, 8473);
    			attr_dev(input2, "type", "email");
    			attr_dev(input2, "name", "email");
    			attr_dev(input2, "placeholder", "Email");
    			attr_dev(input2, "class", "svelte-18cudep");
    			add_location(input2, file, 198, 20, 8878);
    			attr_dev(div34, "class", "col50 svelte-18cudep");
    			add_location(div34, file, 197, 16, 8838);
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "name", "subject");
    			attr_dev(input3, "placeholder", "Subject");
    			attr_dev(input3, "class", "svelte-18cudep");
    			add_location(input3, file, 201, 20, 9011);
    			attr_dev(div35, "class", "col50 svelte-18cudep");
    			add_location(div35, file, 200, 16, 8971);
    			attr_dev(div36, "class", "row svelte-18cudep");
    			add_location(div36, file, 196, 12, 8804);
    			attr_dev(textarea, "name", "message");
    			attr_dev(textarea, "placeholder", "Message");
    			attr_dev(textarea, "class", "svelte-18cudep");
    			add_location(textarea, file, 206, 20, 9197);
    			attr_dev(div37, "class", "col100 svelte-18cudep");
    			add_location(div37, file, 205, 16, 9156);
    			attr_dev(div38, "class", "row svelte-18cudep");
    			add_location(div38, file, 204, 12, 9122);
    			attr_dev(input4, "type", "submit");
    			input4.value = "Send";
    			attr_dev(input4, "class", "svelte-18cudep");
    			add_location(input4, file, 212, 24, 9418);
    			attr_dev(button, "class", "svelte-18cudep");
    			add_location(button, file, 211, 20, 9385);
    			attr_dev(div39, "class", "col100 svelte-18cudep");
    			add_location(div39, file, 210, 16, 9344);
    			attr_dev(div40, "class", "row svelte-18cudep");
    			add_location(div40, file, 209, 12, 9310);
    			attr_dev(div41, "class", "contactForm svelte-18cudep");
    			add_location(div41, file, 187, 8, 8435);
    			attr_dev(form, "action", "https://getform.io/f/04feb2e1-24e2-4e73-98b3-837225c11041");
    			attr_dev(form, "method", "POST");
    			attr_dev(form, "class", "svelte-18cudep");
    			add_location(form, file, 186, 4, 8339);
    			attr_dev(section4, "class", "contact svelte-18cudep");
    			attr_dev(section4, "id", "contact");
    			add_location(section4, file, 181, 0, 8117);
    			attr_dev(p12, "class", "svelte-18cudep");
    			add_location(p12, file, 221, 4, 9592);
    			attr_dev(div42, "class", "copyright svelte-18cudep");
    			add_location(div42, file, 220, 0, 9564);
    			attr_dev(a8, "href", "#home");
    			attr_dev(a8, "class", "svelte-18cudep");
    			toggle_class(a8, "active", /*active*/ ctx[1]);
    			add_location(a8, file, 226, 12, 9756);
    			attr_dev(li3, "class", "svelte-18cudep");
    			add_location(li3, file, 226, 8, 9752);
    			attr_dev(a9, "href", "#about");
    			attr_dev(a9, "class", "svelte-18cudep");
    			toggle_class(a9, "active", /*active*/ ctx[1]);
    			add_location(a9, file, 227, 12, 9835);
    			attr_dev(li4, "class", "svelte-18cudep");
    			add_location(li4, file, 227, 8, 9831);
    			attr_dev(a10, "href", "#services");
    			attr_dev(a10, "class", "svelte-18cudep");
    			toggle_class(a10, "active", /*active*/ ctx[1]);
    			add_location(a10, file, 228, 12, 9916);
    			attr_dev(li5, "class", "svelte-18cudep");
    			add_location(li5, file, 228, 8, 9912);
    			attr_dev(a11, "href", "#work");
    			attr_dev(a11, "class", "svelte-18cudep");
    			toggle_class(a11, "active", /*active*/ ctx[1]);
    			add_location(a11, file, 229, 12, 10003);
    			attr_dev(li6, "class", "svelte-18cudep");
    			add_location(li6, file, 229, 8, 9999);
    			attr_dev(a12, "href", "#contact");
    			attr_dev(a12, "class", "svelte-18cudep");
    			toggle_class(a12, "active", /*active*/ ctx[1]);
    			add_location(a12, file, 230, 12, 10082);
    			attr_dev(li7, "class", "svelte-18cudep");
    			add_location(li7, file, 230, 8, 10078);
    			attr_dev(ul1, "class", "menu svelte-18cudep");
    			add_location(ul1, file, 225, 4, 9726);
    			attr_dev(div43, "class", "sidebar svelte-18cudep");
    			toggle_class(div43, "active", /*active*/ ctx[1]);
    			add_location(div43, file, 224, 0, 9654);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler_6 = () => $$invalidate(1, active = !active);
    	$$self.$capture_state = () => ({ onMount, createScene, webgl, active });

    	$$self.$inject_state = $$props => {
    		if ("webgl" in $$props) $$invalidate(0, webgl = $$props.webgl);
